...
rawspeed_source_root = os.environ.get(
    "RAWSPEED_SOURCE_ROOT",
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "build", "dependency_source_roots", "rawspeed"),
)
cams_from_source = os.path.join(rawspeed_source_root, "data", "cameras.xml")
