    ...
    else if (old_version == 2)
    {
        ...
        if (self && self->dev && abs(n->ratio_d) == 1 && n->ratio_n == 0)
        {
            ...
            const float landscape =
                (self->dev->image_storage.orientation & ORIENTATION_SWAP_XY) == 0;
            ...
            if (!correct && safe)
            {
                ...
                dt_print(
                    ...
                    self->dev->image_storage.id, quadratic ? "quadratic " : "",
                    landscape ? "landscape" : "portrait", flipped ? "flipped" : "unflipped",
                    o->aligned ? " aligned-mode" : "", (int)px, (int)py, (int)dx, (int)dy,
                    (int)new_dx, (int)new_dy, ratio, (int)wd, (int)ht);
            }
            else
