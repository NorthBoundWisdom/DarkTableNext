...
gboolean dt_gpx_get_location(const struct dt_gpx_t *, GDateTime *timestamp,
...
void dt_gpx_geodesic_distance(double lat1, double lon1, double lat2, double lon2, double *d,
                              double *delta);
...
void dt_gpx_geodesic_intermediate_point(const double lat1, const double lon1, const double lat2,
                                        ...
                                        const gboolean first_time, double f, double *lat,
                                        double *lon);
