...
dt_help_url urls_db[] = {
    ...
    {"print_settings_printer"
     "module-reference/utility-modules/print/print-settings/#printer"},
    {"print_settings_page"
     "module-reference/utility-modules/print/print-settings/#page"},
    {"print_settings_button"
     "module-reference/utility-modules/print/print-settings/#print-button"},
