...
void init(dt_imageio_module_format_t *self)
{
    ...
    luaA_enum_value_name(L, dt_pdf_stream_encoder_t, DT_PDF_STREAM_ENCODER_ASCII_HEX,
                         "uncompressed");
    luaA_enum_value_name(L, dt_pdf_stream_encoder_t, DT_PDF_STREAM_ENCODER_FLATE, "deflate");

    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, title, char_128);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, size, char_64);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, border, char_64);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, dpi, float);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, rotate, bool);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, pages, _pdf_pages_t);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, icc, bool);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
                                           dt_imageio_pdf_params_t, mode, _pdf_mode_t);
    dt_lua_register_module_member_indirect(L, self, dt_imageio_pdf_t, params,
...
static int _paper_size(dt_imageio_pdf_params_t *d, float *page_width, float *page_height,
                       float *page_border)
{
                ...
                struct dt_dev_pixelpipe_t *pipe, const gboolean export_masks)
{
    ...
    dt_pdf_image_t *image =
        dt_pdf_add_image(d->pdf, image_data, d->params.global.width, d->params.global.height,
...
int dimension(struct dt_imageio_module_format_t *self, dt_imageio_module_data_t *data,
...
{
    dt_conf_set_float("plugins/imageio/format/pdf/dpi",
...
void gui_init(dt_imageio_module_format_t *self)
{
    ...
    d->title = GTK_ENTRY(
        dt_action_entry_new(DT_ACTION(self), N_("title"), G_CALLBACK(title_changed_callback), self,
    ...
    DT_BAUHAUS_COMBOBOX_NEW_FULL(
        d->orientation, self, NULL, N_("page orientation"), _("paper orientation of the PDF"),
        dt_conf_get_int("plugins/imageio/format/pdf/orientation"), orientation_toggle_callback,
        self, N_("portrait"), N_("landscape"));
    ...
    d->border = GTK_ENTRY(dt_action_entry_new(
        DT_ACTION(self), N_("border"), G_CALLBACK(border_changed_callback), self,
    ...
    DT_BAUHAUS_COMBOBOX_NEW_FULL(d->rotate, self, NULL, N_("rotate images"),
                                 ...
                                 rotate_toggle_callback, self, N_("no"), N_("yes"));
    gtk_grid_attach(grid, GTK_WIDGET(d->rotate), 0, ++line, 2, 1);

    // pages all|single images|contact sheet

    DT_BAUHAUS_COMBOBOX_NEW_FULL(
        d->pages, self, NULL, N_("TODO: pages"), _("what pages should be added to the PDF"),
        dt_conf_get_int("plugins/imageio/format/pdf/pages"), pages_toggle_callback, self, N_("all"),
        N_("single images"), N_("contact sheet"));
    ...
    DT_BAUHAUS_COMBOBOX_NEW_FULL(d->icc, self, NULL, N_("embed ICC profiles"),
                                 ...
                                 icc_toggle_callback, self, N_("no"), N_("yes"));
    ...
    DT_BAUHAUS_COMBOBOX_NEW_FULL(d->compression, self, NULL, N_("compression"),
                                 ...
                                 compression_toggle_callback, self, N_("uncompressed"),
                                 N_("deflate"));
    ...
    DT_BAUHAUS_COMBOBOX_NEW_FULL(d->mode, self, NULL, N_("image mode"),
                                 ...
                                 mode_toggle_callback, self, N_("normal"), N_("draft"),
                                 N_("debug"));
