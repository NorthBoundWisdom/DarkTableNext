          ...
          dt_iop_color_intent_t icc_intent, dt_export_metadata_t *metadata)
{
    ...
    if (dt_imageio_export(imgid, attachment->file, format, fdata, high_quality, upscale, is_scaling,
...
void finalize_store(dt_imageio_module_storage_t *self, dt_imageio_module_data_t *params)
{
    ...
    m_msg.lpszSubject = (LPSTR)_convert_to_widechar(CP_UTF8, _("images exported from darktable"));
