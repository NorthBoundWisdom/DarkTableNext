...
static dt_develop_blend_mode_t
_blend_legacy_blend_mode(const dt_develop_blend_mode_t legacy_blend_mode)
{
                                        ...
                                        const int new_version, const int length)
{
    ...
    if (old_version == 1 && new_version == DEVELOP_BLEND_VERSION)
    {
        ...
        if (length != sizeof(dt_develop_blend_params1_t))
            return TRUE;
        ...
        *n = default_display_blend_params; // start with a fresh copy of default parameters
        n->mask_mode = (o->mode == DEVELOP_BLEND_DISABLED_OBSOLETE) ? DEVELOP_MASK_DISABLED :
    ...
    if (old_version == 2 && new_version == DEVELOP_BLEND_VERSION)
    {
        ...
        if (length != sizeof(dt_develop_blend_params2_t))
            return TRUE;
    ...
    if (old_version == 3 && new_version == DEVELOP_BLEND_VERSION)
    {
        ...
        if (length != sizeof(dt_develop_blend_params3_t))
            return TRUE;
    ...
    if (old_version == 4 && new_version == DEVELOP_BLEND_VERSION)
    {
        ...
        if (length != sizeof(dt_develop_blend_params4_t))
            return TRUE;
    ...
    if (old_version == 5 && new_version == DEVELOP_BLEND_VERSION)
    {
       ...
       * hand-drawn mask and/or conditional mask */
        ...
        if (length != sizeof(dt_develop_blend_params5_t))
            return TRUE;
    ...
    if (old_version == 6 && new_version == DEVELOP_BLEND_VERSION)
    {
       ...
       * hand-drawn mask and/or conditional mask */
        ...
        if (length != sizeof(dt_develop_blend_params6_t))
            return TRUE;
    ...
    if (old_version == 7 && new_version == DEVELOP_BLEND_VERSION)
    {
       ...
       * hand-drawn mask and/or conditional mask */
        ...
        if (length != sizeof(dt_develop_blend_params7_t))
            return TRUE;
    ...
    if (old_version == 8 && new_version == DEVELOP_BLEND_VERSION)
    {
       ...
       * hand-drawn mask and/or conditional mask */
        ...
        if (length != sizeof(dt_develop_blend_params8_t))
            return TRUE;
    ...
    if (old_version == 9 && new_version == DEVELOP_BLEND_VERSION)
    {
       ...
       *  hand-drawn mask and/or conditional mask or raster mask */
        ...
        if (length != sizeof(dt_develop_blend_params9_t))
            return TRUE;
    ...
    if (old_version == 10 && new_version == DEVELOP_BLEND_VERSION)
    {
       ...
       *  hand-drawn mask and/or conditional mask or raster mask */
        ...
        if (length != sizeof(dt_develop_blend_params10_t))
            return TRUE;
    ...
    {
        if (length != sizeof(dt_develop_blend_params_t))
            return TRUE;
                                                ...
                                                const int length)
{
    ...
    const gboolean res = dt_develop_blend_legacy_params(module, old_params, old_version, new_params,
                                                        dt_develop_blend_version(), length);
    dt_iop_cleanup_module(module);
    free(module);
    return res;
}
