...
static size_t _build_tag(char *buf, const char *tagname, const char **tagname_ptr,
                         size_t *tagname_len_ptr, const char **text_ptr, size_t *text_len_ptr)
{
    *tagname_ptr = tagname;
                    ...
                    size_t *new_size)
{
    ...
    else if (old_version == 4)
    {
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.dc.creator", &metadata_tagnames[i],
                              &metadata_tagname_len[i], &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
            buf++;
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.dc.publisher", &metadata_tagnames[i],
                              &metadata_tagname_len[i], &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.dc.title", &metadata_tagnames[i], &metadata_tagname_len[i],
                              &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
            buf++;
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.dc.description", &metadata_tagnames[i],
                              &metadata_tagname_len[i], &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.dc.rights", &metadata_tagnames[i], &metadata_tagname_len[i],
                              &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.acdsee.notes", &metadata_tagnames[i],
                              &metadata_tagname_len[i], &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.darktable.version_name", &metadata_tagnames[i],
                              &metadata_tagname_len[i], &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
        ...
        if (strlen(buf) > 0)
        {
            buf += _build_tag(buf, "Xmp.xmpMM.PerservedFileName", &metadata_tagnames[i],
                              &metadata_tagname_len[i], &metadata_texts[i], &metadata_len[i]);
            i++;
        }
        else
