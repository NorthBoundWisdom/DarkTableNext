...
#define dt_lua_async_call(L, nargs, nresults, cb, data)                                            \
...
void dt_lua_async_call_alien_internal(const char *call_function, int line, lua_CFunction function,
                                      int nresults, dt_lua_finish_callback cb, void *data,
                                      dt_lua_async_call_arg_type arg_type, ...);
#define dt_lua_async_call_alien(fn, nresults, cb, data, arg, ...)                                  \
    dt_lua_async_call_alien_internal(__FUNCTION__, __LINE__, fn, nresults, cb, data, arg,          \
                                     __VA_ARGS__)
...
#define dt_lua_async_call_string(lua_string, nresults, cb, data)                                   \
