...
static dt_lua_widget_type_t combobox_type = {.name = "combobox",
...
static void changed_callback(GtkButton *widget, gpointer user_data)
{
    dt_lua_async_call_alien(dt_lua_widget_trigger_callback, 0, NULL, NULL, LUA_ASYNC_TYPENAME,
                            "lua_widget", user_data, LUA_ASYNC_TYPENAME, "const char*",
                            "value-changed", LUA_ASYNC_DONE);
}
...
int dt_lua_init_widget_combobox(lua_State *L)
{
    ...
    dt_lua_widget_register_gtk_callback(L, lua_combobox, "value-changed", "changed_callback",
