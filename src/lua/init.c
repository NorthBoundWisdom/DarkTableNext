...
static lua_CFunction early_init_funcs[] = {dt_lua_init_early_types,   dt_lua_init_early_events,
                                           dt_lua_init_early_modules, dt_lua_init_early_format,
                                           dt_lua_init_early_storage, dt_lua_init_early_lib,
...
static lua_CFunction init_funcs[] = {dt_lua_init_glist,
                                     dt_lua_init_image,
                                     dt_lua_init_styles,
                                     dt_lua_init_print,
                                     ...
                                     dt_lua_init_guides,
                                     dt_lua_init_cairo,
                                     dt_lua_init_password,
                                     dt_lua_init_util,
                                     dt_lua_init_metadata,
#ifdef HAVE_AI
                                     dt_lua_init_ai,
#endif
                                     NULL};
...
{
    darktable.lua_state.ending = true;
    gboolean running = (darktable.lua_state.loop && g_atomic_int_get(&_lua_fully_initialized) &&
